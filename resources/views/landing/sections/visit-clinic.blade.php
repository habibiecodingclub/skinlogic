        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="bg-white rounded-[2rem] overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 group flex flex-col h-full border border-gray-100">
                ...
                <div class="p-8 flex flex-col flex-grow">
                    ...
                    <div class="mb-4">
                        <a href="{{ $loc['map_url'] }}" target="_blank" class="inline-flex items-center gap-1 text-xs font-bold text-blue-600 uppercase tracking-wider hover:text-blue-800 transition-colors">
                    ...
                    <p class="text-gray-600 mb-8 leading-relaxed font-light text-sm flex-grow">
                        {{ $loc['address'] }}
                    </p>
                    ...
                    <a href="https://wa.me/{{ $loc['phone'] }}?text=Halo%20Admin%20SkinLogic%20Cabang%20{{ $loc['city'] }}" 
                       target="_blank" 
                       class="flex items-center justify-center gap-3 w-full py-3.5 bg-slate-900 text-white font-semibold rounded-xl hover:bg-slate-800 hover:-translate-y-1 transition-all duration-300 shadow-md">
