    ...
    <section class="py-20 bg-white">
        <div class="max-w-7xl mx-auto px-6 md:px-12">
            ...
            <div class="mt-24 bg-gradient-to-r from-slate-900 to-slate-800 rounded-3xl p-10 md:p-16 text-center relative overflow-hidden shadow-2xl">
                ...
                <p class="text-slate-300 font-poppins mb-8 max-w-2xl mx-auto relative z-10 text-lg">
                    Konsultasikan masalah kulit Anda dengan dokter ahli kami untuk mendapatkan rekomendasi produk yang tepat.
                </p>
                <a href="https://wa.me/628123456789"
                   class="inline-flex items-center gap-3 bg-white text-slate-900 px-8 py-4 rounded-full font-bold font-poppins hover:bg-pink-50 transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-105 relative z-10">
